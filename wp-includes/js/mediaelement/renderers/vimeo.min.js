    ...
    1: [function(e, t, n) {
        ...
        var T = {
                ...
                getVimeoId: function(e) {
                    return null == e ? null : (e = e.split("?")[0], parseInt(e.substring(e.lastIndexOf("/") + 1), 10))
                }
            },
            r = {
                name: "vimeo_iframe",
                ...
                create: function(m, e, t) {
                    var v = [],
                        ...
                        w = null,
                        n = "";
                    h.options = e, h.id = m.id + "_" + e.prefix, h.mediaElement = m;
                    for (var N = function(e) {
                            m.generateError("Code " + e.name + ": " + e.message, t)
                                ...
                                if (null !== w) switch (i) {
                                    case "src":
                                        ...
                                        w.loadVideo(n).then(function() {
                                            m.originalNode.autoplay && w.play()
                                        }).catch(function(e) {
                                            return N(e)
                                        });
                                        break;
                    ...
                    window["__ready__" + h.id] = function(e) {
                        ...
                        m.originalNode.muted && (w.setVolume(0), g = 0);
                        ...
                        w.on("loaded", function() {
                            w.getDuration().then(function(e) {
                                if (0 < (U = e) && (b = U * e, m.originalNode.autoplay)) {
                                    j = y = !1;
                        ...
                        for (var d = 0, p = (s = ["rendererready", "loadedmetadata", "loadeddata", "canplay"]).length; d < p; d++) {
                            var f = mejs.Utils.createEvent(s[d], h);
                            m.dispatchEvent(f)
                        }
                    };
                    var p = m.originalNode.height,
                        f = m.originalNode.width,
                        ...
                        V = [];
                    return m.originalNode.autoplay && -1 === A.indexOf("autoplay") && V.push("autoplay=1"), m.originalNode.loop && -1 === A.indexOf("loop") && V.push("loop=1"), A = A + (A ? "&" : "?") + V.join("&"), _.setAttribute("id", h.id), _.setAttribute("width", f), _.setAttribute("height", p), _.setAttribute("frameBorder", "0"), _.setAttribute("src", "" + x + A), _.setAttribute("webkitallowfullscreen", "true"), _.setAttribute("mozallowfullscreen", "true"), _.setAttribute("allowfullscreen", "true"), _.setAttribute("allow", "autoplay"), m.originalNode.parentNode.insertBefore(_, m.originalNode), m.originalNode.style.display = "none", T.load({
                        iframe: _,
                        id: h.id
                    }), h.hide = function() {
