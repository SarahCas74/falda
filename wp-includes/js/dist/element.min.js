...
this.wp = this.wp || {}, this.wp.element = function(e) {
    ...
    "o/Ny": function(e, t, r) {
        ...
        function b(e) {
            ...
            switch (a) {
                case "no-more-tokens":
                    ...
                    return y(), !1;
                case "self-closed":
                    return 0 === h ? (null !== v && u.push(n.substr(v, b - v)), u.push(e[p]), o = b + m, !0) : (O(d(e[p], b, m)), o = b + m, !0);
                case "opener":
                    return c.push(d(e[p], b, m, b + m, v)), o = b + m, !0;
                case "closer":
                    ...
                    S.children.push(P), S.prevOffset = b + m;
                    var E = d(S.element, S.tokenStart, S.tokenLength, b + m);
                    return E.children = S.children, O(E), o = b + m, !0;
                default:
                    return y(), !1
            }
        }
        ...
        var A = Object(l.createContext)(void 0),
            ...
            V = new Set(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]),
            W = new Set(["allowfullscreen", "allowpaymentrequest", "allowusermedia", "async", "autofocus", "autoplay", "checked", "controls", "default", "defer", "disabled", "download", "formnovalidate", "hidden", "ismap", "itemscope", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "selected", "typemustmatch"]),
            H = new Set(["autocapitalize", "autocomplete", "charset", "contenteditable", "crossorigin", "decoding", "dir", "draggable", "enctype", "formenctype", "formmethod", "http-equiv", "inputmode", "kind", "method", "preload", "scope", "shape", "spellcheck", "translate", "type", "wrap"]),
            N = new Set(["animation", "animationIterationCount", "baselineShift", "borderImageOutset", "borderImageSlice", "borderImageWidth", "columnCount", "cx", "cy", "fillOpacity", "flexGrow", "flexShrink", "floodOpacity", "fontWeight", "gridColumnEnd", "gridColumnStart", "gridRowEnd", "gridRowStart", "lineHeight", "opacity", "order", "orphans", "r", "rx", "ry", "shapeImageThreshold", "stopOpacity", "strokeDasharray", "strokeDashoffset", "strokeMiterlimit", "strokeOpacity", "strokeWidth", "tabSize", "widows", "x", "y", "zIndex", "zoom"]);
        ...
        function U(e) {
            return Object(j.startsWith)(e, "--") ? e : z(e, ["ms", "O", "Moz", "Webkit"]) ? "-" + Object(j.kebabCase)(e) : Object(j.kebabCase)(e)
        }

        function K(e, t) {
            return "number" != typeof t || 0 === t || N.has(e) ? t : t + "px"
        }

        function Y(e, t) {
            var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            if (null == e || !1 === e) return "";
            if (Array.isArray(e)) return X(e, t, r);
            switch (Object(a.a)(e)) {
                case "string":
            ...
            switch (n) {
                case l.StrictMode:
                case l.Fragment:
                    return X(o.children, t, r);
                case D:
                    var u = o.children,
                        c = Object(v.a)(o, ["children"]);
                    return q(Object(j.isEmpty)(c) ? null : "div", I({}, c, {
                        dangerouslySetInnerHTML: {
                            __html: u
                        }
                    }), t, r)
            ...
            switch (Object(a.a)(n)) {
                case "string":
                    return q(n, o, t, r);
                case "function":
                    return n.prototype && "function" == typeof n.prototype.render ? Q(n, o, t, r) : Y(n(o, r), t, r)
            }
            switch (n && n.$$typeof) {
                case T.$$typeof:
                    return X(o.children, o.value, r);
                case L.$$typeof:
                    return Y(o.children(t || n._currentValue), t, r);
                case _.$$typeof:
                    return Y(n.render(o), t, r)
            }
            return ""
        }
        ...
        function q(e, t, r) {
            var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                o = "";
            if ("textarea" === e && t.hasOwnProperty("value") ? (o = X(t.value, r, n), t = Object(j.omit)(t, "value")) : t.dangerouslySetInnerHTML && "string" == typeof t.dangerouslySetInnerHTML.__html ? o = t.dangerouslySetInnerHTML.__html : void 0 !== t.children && (o = X(t.children, r, n)), !e) return o;
            var u = G(t);
            return V.has(e) ? "<" + e + u + "/>" : "<" + e + u + ">" + o + "</" + e + ">"
        }
        ...
        function G(e) {
            ...
            for (var r in e) {
                ...
                if (Object(k.isValidAttributeName)(n)) {
                    var o = $(r, e[r]);
                    if (R.has(Object(a.a)(o)) && !F(r)) {
                        var u = W.has(n);
                        if (!u || !1 !== o) {
                            var c = u || z(r, ["data-", "aria-"]) || H.has(n);
